...
WSDL.prototype.objectToDocumentXML = function(name, params, nsPrefix, nsURI, type) {
  var message = '';
  message = message + '<' + name + ' xmlns="http://www.miibeian.gov.cn">';
  if(typeof params === 'object') {
    for (var attr in params) {
      message = message + '<' + attr + ' xmlns="">';


      if(typeof attr === 'number' ){
        message = message + params[attr].toString()
      } else if(typeof attr === 'string') {
        message = message + params[attr];
      }
